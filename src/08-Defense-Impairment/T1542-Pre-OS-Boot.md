...
- [T1542.001 - 系统固件](./T1542/T1542.001-System-Firmware.md) — 感染主板上存储固件的芯片，就像在房子的地基里埋了窃听器。
- [T1542.003 - 引导工具包](./T1542/T1542.003-Bootkit-Bootkit.md) — 在保安上班前就躲在保安室里，然后控制保安的一举一动。
