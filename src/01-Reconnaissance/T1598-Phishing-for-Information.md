...
**详细说明：**
通过LinkedIn、Facebook等平台冒充熟人发送钓鱼消息，收集个人信息。

### T1598.002 - 附件型钓鱼

**通俗理解：** 发带毒的文档，打开后自动窃取信息

**详细说明：**
发送包含恶意宏或脚本的文档附件，执行后收集目标的信息。

### T1598.003 - 链接型钓鱼

**通俗理解：** 发假链接，点进去后输入的信息直接发给攻击者
...
**通俗理解：** 冒充xxx部门打电话来套取信息

**详细说明：**
通过电话冒充IT支持、银行客服等，实时骗取敏感信息。
