...
**详细说明：**
通过SecurityTrails等平台查询历史DNS数据，发现目标的基础设施变化。
...
**详细说明：**
查询域名注册人的姓名、邮箱、电话等信息，可能泄露真实身份。

### T1596.003 - 数字证书

**通俗理解：** 通过SSL证书找到目标的所有子域名

**详细说明：**
通过crt.sh等证书透明度平台查询SSL证书，发现关联的子域名。
...
**详细说明：**
识别目标使用的CDN服务商和节点分布情况。

### T1596.005 - 扫描数据库

**通俗理解：** 用Shodan搜目标暴露了什么设备在网上

**详细说明：**
通过Shodan、Censys、FOFA等平台搜索目标暴露的资产。
