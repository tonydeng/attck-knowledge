...
**通俗理解：** 查目标域名的"户口本"，看是谁注册的、什么时候到期的

**详细说明：**
通过WHOIS查询获取域名注册人、注册商、注册/到期时间、DNS服务器等信息。

### T1590.002 - DNS

**通俗理解：** 查目标的"电话本"，看各个子域名对应什么IP

**详细说明：**
查询A、MX、TXT、CNAME等DNS记录，发现子域名和关联服务。

### T1590.003 - 网络信任依赖

**通俗理解：** 了解目标跟哪些公司有"内部通道"

**详细说明：**
识别组织之间的信任关系，如AD域信任、云平台跨账户信任、B2B VPN连接等。
...
**详细说明：**
通过traceroute、TTL分析等手段推断网络结构和子网划分。
...
**详细说明：**
通过探测响应特征识别防火墙、IDS/IPS、WAF等安全设备的类型和厂商。
