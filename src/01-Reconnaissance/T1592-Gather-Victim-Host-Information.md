...
**详细说明：**
通过采购记录、招聘信息或主动探测获取CPU、内存、网卡等硬件信息。
...
**详细说明：**
通过HTTP头部、水坑攻击脚本、招聘信息中暴露的技术栈获取操作系统和应用版本。

### T1592.003 - 固件

**通俗理解：** 了解目标设备的"底层系统"版本

**详细说明：**
通过管理员接口、公开文档或主动探测获取BIOS/UEFI、路由器固件等版本信息。
...
**详细说明：**
通过水坑攻击或信息窃取木马获取浏览器配置、安全软件类型等客户端信息。
