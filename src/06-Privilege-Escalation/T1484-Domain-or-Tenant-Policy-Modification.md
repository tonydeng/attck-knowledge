...
- [T1484.001 - 组策略修改](./T1484/T1484.001-Group-Policy-Modification.md) — 修改公司总部下发的"统一规定"，所有分公司都会执行。
- [T1484.002 - 信任修改](./T1484/T1484.002-Trust-Modification.md) — 在大楼的认证系统中植入一个"万能钥匙"——可以打开所有的门。
- [T1484.003 - 云策略修改](./T1484/T1484.003-Cloud-Policy-Modification.md) — 修改云平台的"安保策略"，取消所有安全限制。
...
**用人话说：** 域或租户策略修改是攻击者篡改企业身份管理系统的核心配置以获得持久化高权限访问。包括修改Active Directory组策略对象（GPO）、修改AD信任关系、修改Azure AD条件访问策略、以及修改云平台的隐式信任设置。这就像攻击者混进了公司的规章制度委员会，把"员工进出权限规定"改成了"所有门禁对攻击者完全开放"——修改规则本身就是在行使最高权力。
