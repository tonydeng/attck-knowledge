...
- [T1195.001 - 破坏软件依赖和开发工具](./T1195/T1195.001-Compromise-Software-Dependencies-and-Dev-Tools.md) — 攻击者污染了程序员用的"零件库"，程序员不知不觉用了带毒的零件。
- [T1195.002 - 破坏软件供应链](./T1195/T1195.002-Compromise-Software-Supply-Chain.md) — 攻击者入侵了软件工厂，在生产线上动了手脚。
- [T1195.003 - 破坏硬件供应链](./T1195/T1195.003-Compromise-Hardware-Supply-Chain.md) — 攻击者在硬件生产过程中植入了"后门芯片"。
