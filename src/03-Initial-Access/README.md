...
|----------|------|:----:|-----------|:--------:|
| [T1078.001](./T1078/T1078.001-Default-Accounts.md) | 默认账户 | ⭐ | 利用系统或设备出厂时自带的默认账户和密码（如admin/admin） | ✅ 已完成 |
| [T1078.002](./T1078/T1078.002-Domain-Account.md) | 域账户 | ⭐ | 利用Active Directory域账户，可以访问整个企业网络 | ✅ 已完成 |
| [T1078.003](./T1078/T1078.003-Local-Account.md) | 本地账户 | ⭐ | 利用单台电脑上的本地账户，权限有限但可用于横向移动 | ✅ 已完成 |
| [T1078.004](./T1078/T1078.004-Cloud-Account.md) | 云账户 | ⭐ | 利用云服务账户（如Office 365、AWS）访问云端资源 | ✅ 已完成 |
| [T1195.001](./T1195/T1195.001-Compromise-Software-Dependencies-and-Dev-Tools.md) | 破坏软件依赖和开发工具 | ⭐⭐⭐ | 在开源库、包管理器或开发工具中注入恶意代码，开发者下载使用就会中招 | ✅ 已完成 |
| [T1195.002](./T1195/T1195.002-Compromise-Software-Supply-Chain.md) | 破坏软件供应链 | ⭐⭐⭐ | 入侵软件构建或分发过程，在软件安装包中植入后门 | ✅ 已完成 |
| [T1195.003](./T1195/T1195.003-Compromise-Hardware-Supply-Chain.md) | 破坏硬件供应链 | ⭐⭐⭐ | 在硬件制造或分发过程中植入恶意芯片或固件 | ✅ 已完成 |
| [T1566.001](./T1566/T1566.001-Spearphishing-Attachment.md) | 鱼叉式钓鱼附件 | ⭐ | 通过恶意附件（如带宏的Office文档、PDF）投递恶意软件 | ✅ 已完成 |
| [T1566.002](./T1566/T1566.002-Spearphishing-Link.md) | 鱼叉式钓鱼链接 | ⭐ | 通过恶意链接诱导用户访问钓鱼网站或下载恶意软件 | ✅ 已完成 |
| [T1566.003](./T1566/T1566.003-Spearphishing-via-Service.md) | 通过服务进行鱼叉式钓鱼 | ⭐ | 利用第三方服务（如社交媒体、个人邮箱）发送钓鱼消息 | ✅ 已完成 |
| [T1566.004](./T1566/T1566.004-Spearphishing-Voice.md) | 鱼叉式钓鱼语音（Vishing） | ⭐ | 通过语音电话进行社会工程学攻击 | ✅ 已完成 |
