...
| 技术ID | 技术名称 | 关系说明 |
|--------|----------|----------|
| [T1555.003](./T1555-Credentials-from-Password-Stores.md) | 密码存储凭证提取：Web浏览器 | **包含关系**：T1555.003（Web Browsers）覆盖与T1503相同的浏览器凭证窃取功能，但T1555.003是T1555（密码存储凭证提取）的一个子技术，而T1503是独立技术。两者在浏览器密码提取方面功能重叠，T1503专注于浏览器，T1555涵盖更广泛的密码存储类型（Keychain、Windows凭据管理器、第三方密码管理器等）。 |
