...
```mermaid
graph TD
    A["获取管理员权限"] --> B["枚举注册表凭据存储位置"]
    B --> C["读取WinLogon/DefaultPassword键值"]
    C --> D["解码并提取明文密码"]
    D --> E["利用凭证登录其他系统"]
...
- **目标**: 多个行业组织
- **攻击组织**: 多个APT组织
- **手法**: 攻击者在入侵过程中使用Credentials in Registry技术，展示了该子技术的典型应用场景和攻击效果
...
- **目标**: 安全研究测试环境
- **攻击组织**: 红队/安全研究人员
- **手法**: 在授权测试中模拟Credentials in Registry攻击，验证防御体系的检测和响应能力
